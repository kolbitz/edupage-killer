...
- Name: assignments.spec.ts >> assignments >> assignments tab does not fetch grades initially
- Location: e2e/assignments.spec.ts:27:3
...
Locator: getByText('Chapter 5 Homework')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Chapter 5 Homework')
