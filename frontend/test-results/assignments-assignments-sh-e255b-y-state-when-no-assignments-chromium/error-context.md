...
- Name: assignments.spec.ts >> assignments >> shows empty state when no assignments
- Location: e2e/assignments.spec.ts:21:3
...
Locator: getByText('No assignments yet')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('No assignments yet')
