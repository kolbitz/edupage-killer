...
- Name: assignments.spec.ts >> assignments >> max score is displayed when present
- Location: e2e/assignments.spec.ts:70:3
...
Call log:
  ...
  - waiting for getByText('Max: 100 pts')
