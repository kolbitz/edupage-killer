...
- Name: assignments.spec.ts >> assignments >> non-overdue assignment shows gray due-date text
- Location: e2e/assignments.spec.ts:64:3
...
Locator: locator('span.text-gray-500').filter({ hasText: /Due/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('span.text-gray-500').filter({ hasText: /Due/ })
