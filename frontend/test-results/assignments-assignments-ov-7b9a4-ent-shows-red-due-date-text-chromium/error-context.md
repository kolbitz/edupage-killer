...
- Name: assignments.spec.ts >> assignments >> overdue assignment shows red due-date text
- Location: e2e/assignments.spec.ts:55:3
...
Locator: locator('span.text-red-500').filter({ hasText: /Due/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('span.text-red-500').filter({ hasText: /Due/ })
