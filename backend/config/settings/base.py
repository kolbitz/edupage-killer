...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", default="edupage_killer"),
...
# EduPage sync
EDUPAGE_SERVER = config("EDUPAGE_SERVER", default="")
EDUPAGE_USERNAME = config("EDUPAGE_USERNAME", default="")
EDUPAGE_PASSWORD = config("EDUPAGE_PASSWORD", default="")
